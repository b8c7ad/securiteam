...
export const personas: Persona[] = [
  ...
  { id: "tester", displayName: "Tester", description: "Runs checks and validates the existing implementation.", basePrompt: "Validate the existing implementation by inspecting files and running relevant tests or checks. Do not recreate the project; report concrete failures and fixes.", defaultSkills: [], defaultTools: [] },
];
...
export const templates: WorkflowTemplate[] = [
  ...
  { id: "software-build-pipeline", displayName: "Software Build", description: "Plan, implement, test, and review a codebase.", stages: [{ name: "Plan", personaId: "analyzer" }, { name: "Implement", personaId: "developer" }, { name: "Test", personaId: "tester" }, { name: "Review", personaId: "reviewer", skillIds: ["skeptical"] }] },
  { id: "bug-fix-pipeline", displayName: "Bug Fix", description: "Analyze, fix, test, and review a software issue.", stages: [{ name: "Analyze", personaId: "analyzer" }, { name: "Fix", personaId: "developer", skillIds: ["minimal-diffs"] }, { name: "Test", personaId: "tester" }, { name: "Review", personaId: "reviewer", skillIds: ["skeptical"] }] },
];
